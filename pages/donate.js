      ...
      <main className="main">
        ...
        <section className={styles.sectionGem}>
          <div className={clsx(["section-content", styles.contentNarrow])}>
            ...
            <p>
              Over the years, we've honed <i>Evolve</i> into a powerful and
              proven product. A way to generate compassion and empathy, even in
              the midst of profound disagreement.
            </p>
            <p>
              Now, it is time to take <i>Evolve</i> further. To bring this work
              to every city, community, law enforcement and every criminal
              justice agency in America.{" "}
              <strong>
                Donate to The Red Door Project and help create a society where
            ...
            <p className="s1">
              The Red Door Project is a 501(c)(3) nonprofit, charitable
              organization based in Portland, Oregon. Additional information is
              available from the Oregon Department of Justice Charitable
              Activities Section at 971.673.1880.
            </p>
          </div>
        </section>
        <div className={clsx(["section", styles.sectionBlack])}>
          ...
          <div className={clsx(["section-content", styles.contribution])}>
            ...
            <div className={styles.sectionListItem}>
              <div className={styles.sectionImage}>
                <img
                  src="/assets/cultural_trust_logo.png"
                  alt="Cultural Trust logo"
                />
              </div>
              <div className={styles.sectionDescription}>
                <h3 className={styles.h3}>Oregon Cultural Trust</h3>
                <p>
                  Do you live in Oregon? Have you already donated to the Red
                  Door this year? You can double your impact for free! Make a
                  matching donation to the Oregon Cultural Trust by December
                  31st and claim the amount of your donation to the Trust as a
                  tax credit.{" "}
                  <Link
            ...
            <div className={styles.sectionListItem}>
              <div className={styles.sectionImage}>
                <img
                  src="/assets/amazon_smile_logo.png"
              ...
              <div className={styles.sectionDescription}>
                ...
                <p>
                  ...
                  The Red Door Project every time you shop, at no cost to you.
                  When you shop at{" "}
                  <Link
                  ...
                  ></Link>
                  , you’ll have the same shopping experience as Amazon.com, with
                  the added bonus that Amazon will donate .5% of the purchase
                  price to the Red Door Project.
                </p>
                ...
                <p>
                  ...
                  <Link
                    ...
                    text="smile.amazon.com"
                  ></Link>
                  . On your first visit to AmazonSmile, you need to select a
                  non-profit to receive donations from your purchases before you
                  begin shopping. Simply type in The Red Door Project and select
                  us. AmazonSmile will remember your selection, and then every
                  eligible purchase you make on AmazonSmile will result in a
                  donation.
                </p>
              </div>
            </div>
            ...
            <div className={styles.sectionListItem}>
              ...
              <div className={styles.sectionDescription}>
                <h3 className={styles.h3}>
                  Shop With Your Fred Meyer’s Reward Card
                </h3>
                ...
                <ul>
                  ...
                  <li>
                    Search for us by name (The Red Door Project) or by our
                    non-profit number (VK442)
                  </li>
                  <li>
                    Then, every time you shop and use your Rewards Card, you are
                    helping The Red Door Project earn a donation. The more
                    supporters who register their Rewards Card and link it to
                    The Red Door Project, the larger our donation!
                  </li>
                </ul>
              </div>
            </div>
